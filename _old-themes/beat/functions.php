...
function boilerplate_comment( $comment, $args, $depth ) {
	...
	<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
		<article id="comment-<?php comment_ID(); ?>">
			...
			<div class="comment-author vcard ui-block-1">
			...
			<div class="comment-body ui-block-2">
				...
				<footer class="comment-meta commentmetadata">
					...
					<?php printf( __( '<span class="says">By</span> %s', 'boilerplate' ), sprintf( '<cite class="fn">%s</cite>', get_comment_author_link() ) ); ?>
...
/* Beat custom styles */
add_image_size( 'lead-image', 840, 9999 );
