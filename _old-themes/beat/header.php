...
<!--[if (gt IE 9)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	<head>
		...
		<link rel="apple-touch-icon" href="<?php echo home_url( '/' ); ?>apple-touch-icon-precomposed.png" />
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
	...
	<div class="wrapper"><!-- put this here to contain content -->
