...
<form method="post">
	...
	<div class="tribe-events-community-footer">
		...
		<input type="submit" class="button submit events-community-submit" value="<?php
			echo ( $tribe_organizer_id ) ? sprintf(__( 'Update %s', 'tribe-events-community' ), $organizer_label_singular) : sprintf(__( 'Submit %s', 'tribe-events-community' ), $organizer_label_singular);
