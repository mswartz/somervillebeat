	...
	<table class="tribe-community-event-info" cellspacing="0" cellpadding="0">
		...
		<tr>
			<td colspan="2" class="tribe_sectionheader">
				<h4><label class="<?php echo tribe_community_events_field_has_error('organizer')?'error':''; ?>"><?php printf(__( '%s Details', 'tribe-events-community' ), $organizer_label_singular); ?> <?php echo tribe_community_required_field_marker('organizer'); ?></label></h4>
