...
if ( !defined('ABSPATH') ) { die('-1'); }
	...
	<div id="add-new"><a href="<?php echo tribe_community_events_add_event_link(); ?>" class="button"><?php echo apply_filters( 'tribe_ce_add_event_button_text', __( 'Add New','tribe-events-community' ) ); ?></a></div>
			...
			<tbody id="the-list"><tr>
				...
				while ( $events->have_posts() ) {
					...
					<tr>
						...
						<td><?php echo TribeCommunityEvents::instance()->getEventStatusIcon( $post->post_status ); ?></td>
						<td>
						<?php
						...
						<div class="row-actions">
							...
							<?php endif; ?>
							<?php if ( $canEdit ) {
								echo TribeCommunityEvents::instance()->getEditButton( $post, __( 'Edit', 'tribe-events-community' ), '<span class="edit wp-admin events-cal"> |', '</span> ' );
							}
							if ( $canDelete ) {
